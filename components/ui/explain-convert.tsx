...
export default function ExplainConvert({ format }: { format: string }) {
  const sentence = format === "mp3" ? `MP3 for audio` : `MP4 for video`;
  const data = [
    {
      title: "Step 1",
      description:
    ...
    {
      title: "Step 2",
      description: `Select your desired format: ${sentence} using our YTMP3 converter.`,
      image: step2,
    },
    {
      title: "Step 3",
  ...
  return (
    <div className="mt-10 flex flex-col w-screen  bg-[#F1F1F1]" id="about">
      <h1 className="mt-10 text-center text-xl font-bold">
        How to use the YouTube to {format} Converter ?
      </h1>
